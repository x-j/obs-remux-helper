...
if __name__ == '__main__':
    ...
    parser.add_argument('-sd', '--straight_delete', dest="straight_delete", action="store_true", required=False,
                        help="add this flag if you want to directly delete files instead of moving them to trash")
    parser.add_argument('--skipSFK', dest='skip_sfk', action="store_true", required=False,
                        help="add this flag if for some reason you don't want this script to delete your SFK and SFL files.")
    parser.add_argument('--recurse', dest='recurse', action="store_true", required=False,
